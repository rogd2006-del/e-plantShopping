...
const CartItem = ({ onContinueShopping }) => {
  ...
  // Helper function to safely parse the cost string (e.g., "$15" -> 15)
  const parseCost = (cost) => {
    return parseFloat(cost.toString().replace('$', '')) || 0;
  };
  ...
  // Decrement item quantity (and remove if it drops below 1)
